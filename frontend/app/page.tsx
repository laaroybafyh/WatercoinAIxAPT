...
import { fetchAverages } from '../lib/aptosAgent';
...
export default function HomePage() {
  ...
  // Periodically fetch backend averages (if canister available)
  useEffect(() => {
    let active = true;
    async function load() {
      try {
              ...
              <div className={styles.identWrapper}>
                ...
                {safety.safe ? (
                  ...
                  <div className={`${styles.identBrand} ${styles.identBrandDanger}`}>
                    <div className={styles.identText}>RAW WATER (AIR BAKU)</div>
                  </div>
                )}
              </div>
            </div>
