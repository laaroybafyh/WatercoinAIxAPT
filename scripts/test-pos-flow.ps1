# Watercoin APTOS POS Testing Script
# This script performs comprehensive testing of the APTOS integration and POS system

Write-Host "🚀 WATERCOIN APTOS POS TESTING SCRIPT" -ForegroundColor Green
...
$projectPath = "c:\Users\GL63\Project Development\Watercoin AI Monitoring\AIv2APTOS"
...
# Step 3: Test APTOS integration
Write-Host "`n🧪 STEP 3: TESTING APTOS INTEGRATION" -ForegroundColor Cyan
Set-Location "frontend"
Write-Host "Running APTOS integration tests..." -ForegroundColor Yellow
...
$backendJob = Start-Job -ScriptBlock {
    Set-Location "c:\Users\GL63\Project Development\Watercoin AI Monitoring\AIv2APTOS\server"
    npm run dev
}
...
$frontendJob = Start-Job -ScriptBlock {
    Set-Location "c:\Users\GL63\Project Development\Watercoin AI Monitoring\AIv2APTOS\frontend"
    npm run dev
}
...
Write-Host "   - Click on 'AIR RO 19L' (Rp 6.000 ~ 0.10 APTOS)" -ForegroundColor White
Write-Host "   - Click 'BAYAR APTOS' button" -ForegroundColor White
...
Write-Host "5. Verify APTOS network storage of sensor data" -ForegroundColor Yellow
...
Write-Host "APTOS Network: DevNet" -ForegroundColor Green
