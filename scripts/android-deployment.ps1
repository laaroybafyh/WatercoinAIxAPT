# WATERCOIN APTOS POS - Android Deployment Script
...
Write-Host "📱 WATERCOIN APTOS POS - Android Deployment" -ForegroundColor Cyan
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:theme="@style/Theme.WatercoinAPTOS"
...
android {
    ...
    defaultConfig {
        applicationId "com.watercoin.aptospos"
        minSdkVersion 21
        targetSdkVersion 34
        versionCode 1
        versionName "1.0"
